...
namespace Dream {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// Need to add Key mapping here and figure out new ImGui API
		// TEMPORARY, look at new impl and replace later.
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(DM_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
